...
{
	int index = (int)*(int*)param;
	
	char str[13];
	switch (index) {
		case 0:  strcpy(str, "BCDEFGHILMNP"); break;
		case 1:  strcpy(str, "CBDEFGHILMNP"); break;
		case 2:  strcpy(str, "DBCEFGHIKMNO"); break;
		case 3:  strcpy(str, "EBCDFGHIKMNO"); break;
		case 4:  strcpy(str, "FBCDEGHIKMNO"); break;
		case 5:  strcpy(str, "GBCDEFHIKMNO"); break;
		case 6:  strcpy(str, "HBCDEFGIKMNO"); break;
		case 7:  strcpy(str, "IBCDEFGHKMNO"); break;
		case 8:  strcpy(str, "KBCDEFGHIMNO"); break;
		case 9:  strcpy(str, "MBCDEFGHIKNO"); break;
		case 10:  strcpy(str, "NBCDEFGHIKMO"); break;
		case 11:  strcpy(str, "OBCDEFGHIKMN"); break;
	}
	
    	int n = strlen(str);
    	printf("index: %d, string: %s, len: %d\n", index, str, n);
    	permute(str, 1, n-1);
...
int main()
{
	...
	*/
	...
	for(int i = 0; i < NUM_THREADS; i++ ) {
		//printf("%s\n", str[i]);	
		rc = pthread_create(&threads[i], NULL, thread_1, (void*)&index[i]);
	}
