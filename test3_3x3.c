...
#define A1 17					// sum of row 1
#define A2 14					// sum of row 2
#define A3 14					// sum of row 3

#define B1 17					// sum of column 1
#define B2 14					// sum of column 2
#define B3 14					// sum of column 3
...
if (l == r)
{
    ...
    if (  ((arr[0] + arr[1] + arr[2]) == A1) && 
          ((arr[3] + arr[4] + arr[5]) == A2) &&
          ((arr[6] + arr[7] + arr[8]) == A3) &&
          ((arr[0] + arr[3] + arr[6]) == B1) && 
          ((arr[1] + arr[4] + arr[7]) == B2) &&
          ((arr[2] + arr[5] + arr[8]) == B3) )
	{
		match_number++;
		printf("match: %d\n", match_number);
		print_array(arr, len);
